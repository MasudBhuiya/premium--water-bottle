...
const Shop = () => {
    ...
    return (
        <div>
            <Navbar2></Navbar2>
            <div className="bg-black h-[448px] font-bold flex flex-col items-center justify-center text-white px-5 md:px-0">
            ...
            <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-5 md:px-0 mt-16 md:mt-32">
            {
